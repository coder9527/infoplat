package com.info.fileService.model;
...
public class FileInfo {
	...
	public String getMonthDownCount() {
		return monthDownCount;
	}

	public void setMonthDownCount(String monthDownCount) {
		this.monthDownCount = monthDownCount;
	}
